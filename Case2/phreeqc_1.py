def phreeqc_first_step():
    ...
    infile_path = r'D:\Pycharm\CPqPy/case2\Results\out.txt'
    ...
    np.savetxt('D:\Pycharm\CPqPy/case2\Results/11111111.txt', phresult)
    ...
    timestamped_filename = f"D:\Pycharm\CPqPy/case2\Results\initcon{timestep}.txt"
    np.savetxt(timestamped_filename, infile, fmt='%.15f')
    return
